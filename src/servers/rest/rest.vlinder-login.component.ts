...
import {PingController, PingerController} from './controllers';
import {VlinderLoginInternalController} from './controllers/vlinder-login-internal/vlinder-login-internal.controller';
...
export class VlinderLoginRESTAPIComponent
  implements Component, LifeCycleObserver
{
  status = 'not-initialized';
  initialized = false;
  public name = 'VLN-LOGIN-REST-SERVER';
  ...
  constructor(
    ...
    this.restAppCtx.controller(VlinderLoginInternalController);
    //------------->>>>>--------------//
    //Services
